...
const Footer = () => {
  return (
    <div className="w-full bg-slate-500  xl:pl-8 xl:pb-6 text-white max-xl:px-2 max-xl:pb-2">
      <div className="w-full flex items-center gap-4">
        ...
        <div className="basis-2/6 max-lg:basis-1/2  max-w-[600px] max-md:max-w-[190px] max- max-lg:max-w-[400px] max-xl:max-w-[300px] mx-auto  flex flex-col   pt-4">
          <iframe
            ...
            loading="lazy"
            className=" max-md:max-h-[100px] max-xl:max-w-[320px]  max-md:max-w-[190px] xl:max-w-[400px] mx-auto"
